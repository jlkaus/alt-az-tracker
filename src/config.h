...
// perhaps several saved latitude and longitude and location names? (Home, Dad's, Grandma's, Wildcat Mtn.)
// alignment star data & names
// most recent alignment set
// most recent computed origin offset from alignment
